...
import { generateSaanNuzulMessage, generateKhameneiMessage, generateTafsirNemunehMessage } from "./interpretations.js";
import { actionCodes, all_translations } from "./config.js";

export async function handleCallback ( telegramClient, input, chatId, messageId )
{
