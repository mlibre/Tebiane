...
این روش برای اجرا روی سرویس‌های ابری (مثل Render, Vercel, ...) بهینه‌سازی شده. به جای پرس‌وجوی مداوم، تلگرام خودش پیام‌های جدید رو به یک آدرس اینترنتی (URL) مشخص می‌فرسته که بهینه‌تر و سریع‌تره.
