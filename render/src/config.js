...
if ( !appUrl )
{
	console.warn( "RENDER_URL not set. Skipping webhook setup." );
	throw new Error( "RENDER_URL is required" );
}
...
if ( !redisUrl )
{
	console.warn( "KV environment variables (REDIS_URL) not fully set. KV features will be disabled." );
