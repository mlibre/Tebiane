...
const json6 = require( "../sources/quran-simple-clean.fixed.json" );
const json7 = require( "../sources/quran-simple-enhanced.fixed.json" );
const allSurah = require( "../sources/all_surah.json" );
